...
class PersonalContext:
    """Build bounded personal context for one authenticated identity."""

    def __init__(
        self,
        memory: MemoryStore | None = None,
        profile: PersonalProfileStore | None = None,
        tasks: TaskStore | None = None,
    ):
        self.memory = memory or MemoryStore()
        self.profile = profile or PersonalProfileStore()
    ...
    def build(self, request: str) -> dict:
        ...
        return {
            "profile": {
                ...
                "routines": p.routines,
                "goals": p.goals,
                "important_notes": p.important_notes[-20:],
            },
